...
from .code import KERProgram, KERTextFunctionProgramConverter
...
class Evaluation(ABC):
    def __init__(
            self,
            template_program: str | KERProgram,
...
class CPPSecureEvaluator:
    ...
    def evaluate_program(self, program: str | KERProgram, **kwargs):
        try:
    ...
    def evaluate_program_record_time(self, program: str | KERProgram, **kwargs):
