...
from llm4ad.task.optimization.bbob_cr.template import template_program, task_description
from llm4ad.task.optimization.bbob_cr.core import *

__all__ = ['BBOBEvaluationCR13']


class BBOBEvaluationCR13(Evaluation):
