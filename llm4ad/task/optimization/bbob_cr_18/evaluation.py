...
from llm4ad.task.optimization.bbob_cr_18.template import template_program, task_description
from llm4ad.task.optimization.bbob_cr_18.core import *

__all__ = ['BBOBEvaluationCR18']


class BBOBEvaluationCR18(Evaluation):
    ...
    def evaluate(self, eva: Callable, program_str: str) -> float:
        ...
        fitness = main(num_process=10, total_runs=10, test_problems=[18],
