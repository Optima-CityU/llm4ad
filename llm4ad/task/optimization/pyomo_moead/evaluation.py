# Module Name: MOEAD_PYOMO_Evaluation
...
from llm4ad.task.optimization.pyomo_moead.get_instance import GetData
from llm4ad.task.optimization.pyomo_moead.template import template_program, task_description

class MOEAD_PYOMO_Evaluation(Evaluation):
    def __init__(self,
                 timeout_seconds=100,
                 n_var=10,
                 n_obj=3,
...
if __name__ == "__main__":
    ...
    evaluator = MOEAD_PYOMO_Evaluation(n_gen=100, seed=1)
