...
from llm4ad.task.optimization.assignment_problem_co_bench.template import template_program, task_description

__all__ = ['APEvaluation']


class APEvaluation(Evaluation):
    ...
    def __init__(self,
        ...
        self._datasets = [e for e in ins_files_path if e.endswith('.txt')]
        ...
        try:
            for i in ins_cases:
                for j in i:
                    ...
                    fitness = self.eval_func(case=j, solution=result)
