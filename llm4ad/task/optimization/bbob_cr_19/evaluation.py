...
from llm4ad.task.optimization.bbob_cr_19.template import template_program, task_description
from llm4ad.task.optimization.bbob_cr_19.core import *

__all__ = ['BBOBEvaluationCR19']


class BBOBEvaluationCR19(Evaluation):
    ...
    def evaluate(self, eva: Callable, program_str: str) -> float:
        ...
        fitness = main(num_process=10, total_runs=10, test_problems=[19],
