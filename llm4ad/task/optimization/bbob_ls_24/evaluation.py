...
from llm4ad.task.optimization.bbob_ls_24.template import template_program, task_description
from llm4ad.task.optimization.bbob_ls_24.core import *

__all__ = ['BBOBEvaluationLS24']


class BBOBEvaluationLS24(Evaluation):
    ...
    def evaluate(self, eva: Callable, program_str: str) -> float:
        ...
        fitness = main(num_process=10, total_runs=10, test_problems=[24],
