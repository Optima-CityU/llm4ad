...
from llm4ad.task.optimization.bbob_cr_17.template import template_program, task_description
from llm4ad.task.optimization.bbob_cr_17.core import *

__all__ = ['BBOBEvaluationCR17']


class BBOBEvaluationCR17(Evaluation):
    ...
    def evaluate(self, eva: Callable, program_str: str) -> float:
        ...
        fitness = main(num_process=10, total_runs=10, test_problems=[17],
