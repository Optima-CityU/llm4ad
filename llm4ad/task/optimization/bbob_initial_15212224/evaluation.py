...
__all__ = ['BBOBEvaluationINI15212224']


class BBOBEvaluationINI15212224(Evaluation):
    ...
    def evaluate(self, eva: Callable, program_str: str) -> float:
        ...
        fitness = main(num_process=num_process, total_runs=total_runs, test_problems=[15,21,22,24],
