...
from llm4ad.task.optimization.bbob_cr_24.template import template_program, task_description
from llm4ad.task.optimization.bbob_cr_24.core import *

__all__ = ['BBOBEvaluationCR14']


class BBOBEvaluationCR14(Evaluation):
    ...
    def evaluate(self, eva: Callable, program_str: str) -> float:
        ...
        fitness = main(num_process=num_process, total_runs=total_runs, test_problems=[14],
