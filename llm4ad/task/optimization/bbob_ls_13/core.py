...
from llm4ad.task.optimization.bbob_ls_13.lshade import *
...
def run_single(problem_index, run_index, random_seed, func):
    ...
    program_callable = all_globals_namespace['local_search']
    de.local_search = types.MethodType(program_callable, de)
    de.optimize()
