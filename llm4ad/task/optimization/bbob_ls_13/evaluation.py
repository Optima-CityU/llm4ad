...
from llm4ad.task.optimization.bbob_ls_13.template import template_program, task_description
from llm4ad.task.optimization.bbob_ls_13.core import *

__all__ = ['BBOBEvaluationLS13']


class BBOBEvaluationLS13(Evaluation):
    ...
    def evaluate(self, eva: Callable, program_str: str) -> float:
        ...
        fitness = main(num_process=10, total_runs=10, test_problems=[13],
