...
default_model_path_path = '/raid/zhichao/zhangrui/LLMs/Qwen2.5-Coder-7B-Instruct'
...
def completions():
    ...
    if isinstance(prompt, str):
        ...
        # prompt = [
        #     {'role': 'system', 'content': 'Assume you are a code completion model. Your task is to complete the code without output additional contents.'},
