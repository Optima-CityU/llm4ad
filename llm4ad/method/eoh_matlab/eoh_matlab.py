...
from ...base import (
    MatlabEvaluation, LLM, MatlabFunction, MatlabProgram, TextMatlabFunctionProgramConverter, SecureMatlabEvaluator
)
...
class EoHMat:
    def __init__(self,
        ...
        self._function_to_evolve: MatlabFunction = TextMatlabFunctionProgramConverter.text_to_function(self._template_program_str)
        self._function_to_evolve_name: str = self._function_to_evolve.name
        self._template_program: MatlabProgram = TextMatlabFunctionProgramConverter.text_to_program(self._template_program_str)
        ...
        self._evaluator = SecureMatlabEvaluator(evaluation, debug_mode=debug_mode, **kwargs)
    ...
    def _sample_evaluate_register(self, prompt):
        ...
        program = TextMatlabFunctionProgramConverter.function_to_program(func, self._template_program)
        if program is None:
            return
        # evaluate
