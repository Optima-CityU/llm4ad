...
from llm4ad.method.funsearch import FunSearch, FunSearchTensorboardProfiler
...
if __name__ == '__main__':
    ...
    profiler = FunSearchTensorboardProfiler(log_dir='logs/run1', initial_num_samples=0, program_db_register_interval=10)
    funsearch = FunSearch(
